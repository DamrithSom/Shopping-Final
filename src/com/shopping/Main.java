...
public class Main {
    public static void main(String[] args) {
        ...
        Customer premiumCustomer = new Customer("Alex", "Premium");
        Customer goldCustomer = new Customer("Ameny", "Gold");
        Customer silverCustomer = new Customer("lyl", "Silver");
        Customer normalCustomer = new Customer("Thyda", "Normal");
